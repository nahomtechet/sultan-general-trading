...
import { Phone, Mail, MapPin, CheckCircle, AlertCircle, Facebook, Twitter, Instagram, Linkedin } from "lucide-react"
          ...
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div id="contact-info">
                    ...
                    <Card>
                      <CardContent className="p-6">
                        <div className="flex items-start space-x-4">
                          ...
                          <div>
                            <h3 className="font-semibold text-lg mb-2">Addis Ababa Head Office</h3>
                            <p className="text-slate-600 dark:text-slate-300">
                              Najip tower, 3rd Floor, Room 302, Bole wollo Sefer, Addis Ababa, Ethiopia
                            </p>
                          </div>
                        </div>
                      </CardContent>
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-start space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-slate-600 dark:text-slate-300">
                              <Link href="tel:+251915042639" className="hover:text-blue-600 transition-colors">
                                +251 915 042 639
                              </Link>
                            </p>
                          </div>
                    ...
                    <Card>
                      <CardContent className="p-6">
                        <div className="flex items-start space-x-4">
                          <MapPin className="h-6 w-6 text-blue-600 shrink-0 mt-1" />
                          <div>
                            <h3 className="font-semibold text-lg mb-2">Turkey Branch</h3>
                            <Link
                              href="https://maps.app.goo.gl/c12UCQ8VDG9qN6Vm8"
                              target="_blank"
                              rel="noopener noreferrer"
                              className="hover:text-blue transition-colors block"
                            >
                              <p className="text-slate-600 dark:text-slate-300">
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-start space-x-4">
                          ...
                          <div>
                            <h3 className="font-semibold text-lg mb-2">Phone</h3>
                            <p className="text-slate-600 dark:text-slate-300">
                              <Link href="tel:+905523414384" className="hover:text-blue-600 transition-colors block">
                                +90 552 341 43 84
                              </Link>
                              <Link
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-4 text-slate-900 dark:text-white">Connect With Us</h3>
